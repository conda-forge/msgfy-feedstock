...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/msgfy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10446&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/msgfy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `msgfy` can be installed with:

```
conda install msgfy
```

It is possible to list all of the versions of `msgfy` available on your platform with:
